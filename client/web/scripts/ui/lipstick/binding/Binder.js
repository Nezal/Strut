...
define([], function() {
  var Binder, callView, comparers, middlewareDefaults;
  ...
  callView = function($target, fn, value) {
    var comp, fnData, fnName, fnType, key, _i, _len, _results, _results1;
    fnType = typeof fn;
    if (Array.isArray(fn)) {
      fnType = "array";
    }
    switch (fnType) {
      ...
      default:
        ...
        for (_i = 0, _len = fn.length; _i < _len; _i++) {
          fnName = fn[_i];
          _results1.push($target[fnName](value));
        }
        return _results1;
    }
  };
